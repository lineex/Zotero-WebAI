...
ai-assistant-pref-commands-help = Add reusable slash skills for PDF reading, selected text, image input, imported PDFs, and note workflows.
...
ai-assistant-pref-mcp-tool-name-label = Tool name
ai-assistant-pref-mcp-tool-arguments-template-label = Tool arguments JSON
ai-assistant-pref-mcp-auth-token-label = Bearer token (optional)
ai-assistant-pref-mcp-help = Use a streamable HTTP MCP endpoint. The JSON template may include {{query}}, which Zotero-WebAI replaces with the current verification query.
