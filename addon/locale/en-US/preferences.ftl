...
ai-assistant-pref-mcp-help = Use a streamable HTTP MCP endpoint. Zotero WebAI embeds the tool schemas automatically so the web model can choose tools and arguments during chat.
